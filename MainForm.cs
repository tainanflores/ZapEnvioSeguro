    ...
    public partial class MainForm : Form
    {
        ...
        private void ShowLoading()
        {
            ...
            loadingGif = new PictureBox
            {
                ...
                BackColor = Color.FromArgb(0,0,0,0), // Transparência no PictureBox
        ...
        private void InicializarComboBoxZapOrigem()
        {
            ...
            // Obtém os valores únicos da coluna TelefoneOrigem
            ...
            // Adiciona os valores únicos ao ComboBox
            cmbZapOrigem.Items.AddRange(telefonesUnicos.ToArray());

            // Define "Todos" como o valor padrão selecionado
            cmbZapOrigem.SelectedIndex = 0;
        }
        ...
        private async void btnEnviar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    current++;
                    string nomeZap = Regex.Replace(contato.PushName.ToString().Trim(), @"[^a-zA-ZáàãâäéèêëíìîïóòôõöúùûüçÇ\s]", string.Empty);
                    string nomeSalvo = Regex.Replace(contato.Nome.ToString().Trim(), @"[^a-zA-ZáàãâäéèêëíìîïóòôõöúùûüçÇ\s]", string.Empty);
